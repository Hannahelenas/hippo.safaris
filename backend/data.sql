...
INSERT INTO Safaris (name, description, price, image, category, country) VALUES ('Ultimate Big Five Safari', 'Embark on a classic safari adventure in the heart of Kruger Park. Witness the breathtaking landscapes and diverse wildlife of South Africa while staying in bush camps and exploring the wilderness with experienced guides.', 1000, 'https://images.unsplash.com/photo-1571464725578-379afac15ae1?q=80&w=2067&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 'Classic', 'South Africa');
